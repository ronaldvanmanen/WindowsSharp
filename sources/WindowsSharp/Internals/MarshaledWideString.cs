...
{
    public unsafe struct MarshaledWideString : IDisposable
    {
        public MarshaledWideString(string input)
        {
            int length;
            IntPtr value;
        ...
        public static implicit operator ushort*(in MarshaledWideString value) => value.Value;
